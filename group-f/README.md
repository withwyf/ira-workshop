...
# 创建你的工作分支
git checkout -b feature/group-f-01-m1

# 命名规范：
# feature/group-f-{编号}-{模块名}
# 示例：feature/group-f-01-m1
#       feature/group-f-03-m2
```
...
# 推送到你的 Fork
git push origin feature/group-f-01-m1
```
...
3. 设置：
   ...
   - base branch: main
   - head branch: feature/group-f-01-m1
4. 填写 PR 描述
...
gh pr create \
  --base main \
  --head feature/group-f-01-m1 \
  --title "Group-F-01: 完成 M1 模块" \
...
示例：
Group-F-01: 完成 M1 模块 Spec 文档
Group-F-03: 实现多源数据集成
Group-F-05: 添加知识库问答功能
```
...
- Spec 文档路径：`group-f/01/docs/`
- 代码路径：`group-f/01/backend/`
...
- ✅ 可以编辑：`group-f/01/`, `group-f/02/`, ...
- ❌ 不要编辑：`group-a/`, `group-c/`, 其他组的目录
