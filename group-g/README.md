...
# 创建你的工作分支
git checkout -b feature/group-g-01-m1

# 命名规范：
# feature/group-g-{编号}-{模块名}
# 示例：feature/group-g-01-m1
#       feature/group-g-03-m2
```
...
# 推送到你的 Fork
git push origin feature/group-g-01-m1
```
...
3. 设置：
   ...
   - base branch: main
   - head branch: feature/group-g-01-m1
4. 填写 PR 描述
...
gh pr create \
  --base main \
  --head feature/group-g-01-m1 \
  --title "Group-G-01: 完成 M1 模块" \
...
示例：
Group-G-01: 完成 M1 模块 Spec 文档
Group-G-03: 实现多源数据集成
Group-G-05: 添加知识库问答功能
```
...
- Spec 文档路径：`group-g/01/docs/`
- 代码路径：`group-g/01/backend/`
