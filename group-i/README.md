...
# 创建你的工作分支
git checkout -b feature/group-i-01-m1

# 命名规范：
# feature/group-i-{编号}-{模块名}
# 示例：feature/group-i-01-m1
#       feature/group-i-03-m2
```
...
# 推送到你的 Fork
git push origin feature/group-i-01-m1
```
...
3. 设置：
   ...
   - base branch: main
   - head branch: feature/group-i-01-m1
4. 填写 PR 描述
...
gh pr create \
  --base main \
  --head feature/group-i-01-m1 \
  --title "Group-I-01: 完成 M1 模块" \
...
示例：
Group-I-01: 完成 M1 模块 Spec 文档
Group-I-03: 实现多源数据集成
Group-I-05: 添加知识库问答功能
```
...
- Spec 文档路径：`group-i/01/docs/`
- 代码路径：`group-i/01/backend/`
