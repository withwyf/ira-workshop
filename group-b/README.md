...
# 命名规范：
# feature/group-b-{编号}-{模块名}
# 示例：feature/group-b-01-m1
...
示例：
Group-B-01: 完成 M1 模块 Spec 文档
Group-B-03: 实现多源数据集成
Group-B-05: 添加知识库问答功能
```
...
- Spec 文档路径：`group-b/01/docs/`
- 代码路径：`group-b/01/backend/`
